...
## Introduction
By all means leave. This is a childs book in foolish curiosity. By all rights it's a foolish book. TO write this to an effective capacity I will be rewatching some of the shows I used to watch growing up to learn language for inspiration for this book(after all I am grown and so it takes effort to think like a child these days, much less remember what things we like when I was a child). Fenyman would be able to write this to much better capacity than I. Von Neumann would conjure up the precise architecture on only seeing a few questions. Edward Teller would demand the most absurd of tasks from the intelligence... etc etc. (how i think various people, based on my readings of them would view or write this book)
